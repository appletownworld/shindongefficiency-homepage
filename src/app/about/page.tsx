          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                ...
                <p>
                  Наша команда с 15-летним опытом в области автоматизации бизнес-процессов 
                  создаёт решения, которые помогают компаниям избавиться от бумажной волокиты, 
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Станьте частью инновационного будущего с Shindong Efficiency
          </p>
